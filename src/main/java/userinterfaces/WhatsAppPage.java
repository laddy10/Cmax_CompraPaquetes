...
public class WhatsAppPage {
    ...
    public static final Target BTN_SELECCIONA =
            Target.the("Boton Selecciona")
                    .located(MobileBy.xpath("//*[@text='Selecciona' and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[./*[@text='\uD83D\uDCE6¡Ahorra y aprovecha al máximo los paquetes TODO INCLUIDO!\n" +
                            "Llamadas, mensajes y datos para navegar todo lo que quieras']]]]"));
    ...
    public static final Target BTN_SELECCIONA_PQ_INTERNACIONAL=
            Target.the("Boton Selecciona paquete Internacional")
                    .located(MobileBy.xpath("//*[@text='Selecciona' and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[./*[@text='\uD83C\uDF0E Las mejores tarifas para conectarte con tus seres queridos y mantenerte conectado sin importar dónde te encuentres.\n" +
                            "\n" +
                            "Recuerda tener saldo disponible para la compra de este paquete']]]]"));
