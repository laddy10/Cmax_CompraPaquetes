...
public class ContadorDeUsoConsumoDeSMS implements Task {

    static DataDrivenExcel dataDriverExcel = new DataDrivenExcel();
    Map<String, String> data = new HashMap<String, String>();

    public ContadorDeUsoConsumoDeSMS(Map<String, String> data) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        System.out.println("Paquete buscado: " + data.get("paqueteSMS"));
        ...
        try {
            for (WebElementFacade row : rows) {
                ...
                if (actualPackageName.equals(data.get("paqueteSMS"))) {
            ...
            if (!paqueteEncontrado) {
                throw new AssertionError(
                        "ERROR: No se encontro el paquete en la pagina web. " + data.get("paqueteSMS"));
            }
    ...
    public static Performable contadordeUsoConsumoDeSMS(Map<String, String> data) {
        return Instrumented.instanceOf(ContadorDeUsoConsumoDeSMS.class).withProperties(data);
    }
}