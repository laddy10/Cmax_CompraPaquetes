...
public class ContadorDeUsoConsumoDeVoz implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        System.out.println("Paquete buscado: " + data.get("paqueteVoz"));
        ...
        try {
            for (WebElementFacade row : rows) {
                ...
                if (actualPackageName.equals(data.get("paqueteVoz"))) {
            ...
            if (!paqueteEncontrado) {
                throw new AssertionError(
                        "ERROR: No se encontro el paquete en la pagina web. " + data.get("paqueteVoz"));
            }
    ...
    public static Performable contadordeUsoConsumoDeVoz(Map<String, String> data) {
        return Instrumented.instanceOf(ContadorDeUsoConsumoDeVoz.class).withProperties(data);
    }
}
